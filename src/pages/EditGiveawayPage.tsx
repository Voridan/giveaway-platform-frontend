  ...
  const handleSubmit = async (e: MouseEvent<HTMLButtonElement>) => {
    ...
    if (isValid) {
      try {
        ...
        const didPartnersChangedV = didPartnersChanged();
        console.log(didPartnersChangedV);

        if (didPartnersChangedV)
...
export default EditGiveawayPage;
